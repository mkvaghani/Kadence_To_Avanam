	...
	return (
		<div className="base-desk-help-inner">
			...
			<div className="video-container">
				<a href="https://www.youtube.com/watch?v="><img width="1280" height="720" src={ baseDashboardParams.videoImage } alt={ __( 'Avanam Theme Getting Started Tutorial - 10 Minute Quick Start Guide', 'avanam' ) } /></a>
			</div>
