					...
					<div class="side-panel">
						...
						<div class="support-section sidebar-section components-panel">
							<div class="components-panel__body is-opened">
								...
								<a href="<?php echo esc_url( \Base\webapp()->get_pro_url( 'https://avanam.org/wordpress#help-center/knowledge-base/base/', 'https://avanam.org/wordpress#help-center/knowledge-base/base/', 'in-app', 'theme-dash', 'docs' ) ); ?>" target="_blank" class="sidebar-link"><?php esc_html_e( 'Browse Docs', 'avanam' ); ?></a>
							</div>
						</div>
						<div class="support-section sidebar-section components-panel">
							<div class="components-panel__body is-opened">
